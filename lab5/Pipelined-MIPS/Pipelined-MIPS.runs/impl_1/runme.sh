...
HD_PWD='C:/Users/mkucu/Documents/CS224/Lab5/Pipelined-MIPS/Pipelined-MIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo.tcl -notrace
