...
HD_PWD='C:/Users/mkucu/Documents/CS224/Lab5/Pipelined-MIPS/Pipelined-MIPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo.tcl
